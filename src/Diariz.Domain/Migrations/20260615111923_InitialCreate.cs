        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Speakers_Recordings_RecordingId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpeakerLabel = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Summaries_Transcriptions_TranscriptionId",
                        column: x => x.TranscriptionId,
                        principalTable: "Transcriptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Recordings_UserId_CreatedAt",
                table: "Recordings",
                columns: new[] { "UserId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_Segments_TranscriptionId_Ordinal",
                table: "Segments",
                columns: new[] { "TranscriptionId", "Ordinal" });

            migrationBuilder.CreateIndex(
                name: "IX_Speakers_RecordingId_Label",
                table: "Speakers",
                columns: new[] { "RecordingId", "Label" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Summaries_TranscriptionId",
                table: "Summaries",
                column: "TranscriptionId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Transcriptions_RecordingId_Version",
                table: "Transcriptions",
                columns: new[] { "RecordingId", "Version" },
                unique: true);
        }
