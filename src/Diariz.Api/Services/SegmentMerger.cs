...
public static class SegmentMerger
{
    ...
    /// <summary>Merge runs of adjacent parts that share a speaker label: text is space-joined, the span
    /// runs from the first start to the last end. Input must already be in display order.</summary>
