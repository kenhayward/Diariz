...
/// people are listed by name; the auto-labelled diarization speakers still on their default <c>SPEAKER_nn</c>
/// label collapse to a count (e.g. "Alice, Bob and 11 unidentified attendees") so the minutes don't spell out a
/// long list of anonymous speakers. Returns null when there are no attendees at all.</summary>
