...
| **Summaries & minutes** | Auto summary plus full professional meeting minutes (WYSIWYG-editable, emailable), driven by reusable meeting-type templates with per-block layout control (break, Markdown, drag-to-reorder) and JSON import/export. |
