...
remembered, and the list refreshes on hot-plug) and **tune capture** (echo cancellation, noise suppression,
auto gain, mono) from a ⚙ popover — or Windows system/loopback audio via the Electron desktop
