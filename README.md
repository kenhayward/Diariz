...
| **Model settings** | Platform-wide LLM controls: minutes-generation mode and a default AI request timeout (120s) covering every AI call including chat and Formula runs, which any user can override for their own account. |
