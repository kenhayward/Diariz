...
/// <see cref="DiarizWebAppFactory"/>, constructed with <c>enableMcp: true</c> - the factory defaults
/// <c>Mcp__Enabled</c> off (see the factory's class remarks) because most of this suite doesn't exercise
/// <c>/mcp</c>; this class specifically targets it, so it opts back in via the supported constructor flag.
/// </summary>
...
public class McpToggleTests(ContainersFixture fx)
{
    ...
    private DiarizWebAppFactory NewFactoryWithMcpEnabled() => new(fx, enableMcp: true);
