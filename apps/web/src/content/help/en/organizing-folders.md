...
goes into whichever folder the list is showing when you press Record, so opening a folder and recording
files the take there; at the top level it goes to Ungrouped.
