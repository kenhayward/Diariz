...
/// bar shows. CalendarSyncProvider sits inside it (it writes the sync's progress line) and above the panel, so
/// a calendar sync outlives the toolbar that started it - the buttons are in a tab that unmounts.
/// HubPopoverProvider spans the workspace so the capture bar and the account menu share one open popover.
