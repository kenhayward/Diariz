...
/// The Profile tab: one person's contact details, their internal/external marker, and the destructive
/// actions the directory offers beside them.
///
/// Moved out of `PersonEditor` unchanged when the Voiceprint tab arrived; `PersonEditor` is now the tab
/// shell. Follows the app's established shape: a local draft copied from the server object, imperative
/// validation in the save handler, and a single error banner - there is no form library here and no schema
/// validation.
///
