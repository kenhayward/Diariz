...
| **Record a calendar meeting** | Join a meeting from your calendar and it records in one click, named after the invite rather than the clock. Optionally let it end itself - a set number of minutes after the meeting was due to finish, or after a run of silence once everyone has left - and joining a second meeting finishes and files the first automatically. |
