...
export const RELEASES: Release[] = [
  {
    ...
    added: [
      ...
      "Filtering by date range (last 30 days by default), user, call type, model, and outcome, with server-side sorting on every displayed column.",
