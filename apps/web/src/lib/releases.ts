...
export const RELEASES: Release[] = [
  {
    ...
    fixed: [
      ...
      "A connection that drops or a read that faults partway through a streamed reply is now recorded as a failed call instead of a success; a user simply closing the tab mid-reply is still correctly not treated as a failure.",
    ],
  },
  {
    version: "0.216.1",
