...
/// In-app API reference (Scalar) backed by the curated, authed OpenAPI document. Reached at
/// /developers/api behind the app login, so it's signed-in users only - and, more usually, as a panel
/// inside Preferences or Settings, which is what `embedded` drops the page chrome for.
export default function ApiReference({ embedded = false }: { embedded?: boolean } = {}) {
